...
class BitfinexGateway(
    ...
    fun retrieveWallets(): String =
        messageSender.sendMessage("v2/auth/r/wallets")
    ...
    fun submitWithdrawalRequest(currency: Currency, amount: String, destinationAddress: String): String {
        val withdrawalRequestDto = BitfinexWithdrawalRequest(
            BitfinexWallet.exchange, currency.code, amount, destinationAddress, paymentIdSupplier()
        )
